...
class StorageService{
  ...
  Future<String> upload({required File file, required String fileName})async{
    ...
    String url =  await _firebaseStorage.ref("$pathService/$fileName.png").getDownloadURL();
  ...
  Future<List<ImageCustomInfo>>  listAllFiles()async{
    ...
    for(Reference reference in listReferences){
      ...
      listFiles.add(ImageCustomInfo(urlDownload: urlDownload, name: name, size: sizeString, ref: reference));
    }
    return listFiles;
  }
